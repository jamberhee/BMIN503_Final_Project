...
Data was weighted using the R package survey 4.4-8 according to the weights provided by the NHIS dataset. Participants missing the exposure, outcome, or both variables were excluded from the calculation of the estimates. They remain included for the calculation of the standard errors.
...
weighted_complete <- subset(weighted_data,complete.cases(comdiff,hip_binary))
